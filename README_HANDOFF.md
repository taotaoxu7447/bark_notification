...
Expected: the explicitly configured personal Bark client or logged-in Android AgentWatch account receives `Codex 测试提醒`. These commands are manual and intentional; install, update, login, and `doctor` never invoke them automatically.
